...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Henor Kelmendi",
		role: "Co-founder",
		image: "/generated/image-a-young-icelandic-entrepreneur-dressed-i.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"At eighteen, we saw startups drowning in generic templates while agencies treated them like checkbox projects. We knew there had to be a better way—thoughtful design that grows with your vision, not against it."`}
			/>
